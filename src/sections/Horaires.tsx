            ...
            <div className="container mx-auto flex justify-center">
                <div className="flex flex-col items-center drop-shadow-lg max-w-[480px]">
                    ...
                    <div className="flex flex-col items-center">
                        <h2 className="font-black text-center text-white mb-5">Du Lundi au Jeudi + Samedi</h2>
                    ...
                    <div className="flex flex-col items-center mt-10">
                        <h2 className="font-black text-center text-white mb-5">Vendredi et Dimanche</h2>
                        <Image src={HeurSoir} alt="Horaires du soir" />
                    </div>
                </div>
            </div>
