    ...
    <section className="w-full">
      <div className="relative w-full bg-secondary">
        ...
        <div className="container px-0 mx-auto flex flex-col items-center h-full pt-24 gap-6">
          ...
          <a
            href="#menus"
            className="relative border border-[#C0A7CC] p-3 rounded-xl bg-gradient-to-b from-[#572D7F] to-[#9D51E5] text-white md:text-xl lg: xl: font-bold shadow-lg before:content-[''] overflow-hidden before:block before:w-40 before:h-3 before:bg-[#F583FF] before:absolute before:top-0 before:left-1/2 before:-translate-x-1/2 before:-translate-y-2 before:blur-[10px] before:transition-all before:duration-300 hover:before:w-48 mt-5 md:mt-0"
          >
            Découvrez nos menus !
          </a>
        </div>
